...
public class OrderControllerTest {
    ...
    @Transactional
    @Test
    public void createOrder_success() throws Exception {   //  創建訂單成功
    ...
    @Transactional
    @Test
    public void createOrder_userNotExist() throws Exception {         //  userId 不存在
        CreateOrderRequest createOrderRequest = new CreateOrderRequest();
        List<BuyItem> buyItemList = new ArrayList<>();
    ...
    @Transactional
    @Test
    public void createOrder_productNotExist() throws Exception {    //  productId 不存在
        CreateOrderRequest createOrderRequest = new CreateOrderRequest();
        List<BuyItem> buyItemList = new ArrayList<>();
    ...
    @Transactional
    @Test
    public void createOrder_stockNotEnough() throws Exception {  // 商品數量不足
        CreateOrderRequest createOrderRequest = new CreateOrderRequest();
        List<BuyItem> buyItemList = new ArrayList<>();
